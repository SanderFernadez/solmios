...
import type { PaquetesDTO, CreatePaquetesDTO, UpdatePaquetesDTO, PaquetesQuery, PaquetesPaginated } from './types'
...
export class PaquetesService {
  ...
  async list(query?: PaquetesQuery): Promise<PaquetesPaginated> {
  ...
  async getById(id: string): Promise<PaquetesDTO> {
  ...
  async update(id: string, dto: UpdatePaquetesDTO): Promise<PaquetesDTO> {
