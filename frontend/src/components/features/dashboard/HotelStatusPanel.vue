<template>
  <div class="rounded-[20px] border border-white/8 bg-[#0B1526] p-5">
    <h2 class="text-xs font-black uppercase tracking-wider text-white">Estado del Hotel</h2>
    <div class="mt-4 space-y-1">
      <div v-for="s in services" :key="s.label" class="flex items-center justify-between rounded-xl px-3 py-2.5 transition-colors hover:bg-white/3">
