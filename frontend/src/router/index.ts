  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'groups', redirect: (to) => ({ path: '/panel/ventas/grupos', query: to.query }) },
        { path: 'packages', redirect: (to) => ({ path: '/panel/ventas/promociones', query: to.query }) },
        { path: 'opiniones', redirect: (to) => ({ path: '/panel/ventas/opiniones', query: to.query }) },
