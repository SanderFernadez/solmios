...
const nonavItems = [
  ...
  {
    label: 'Planificación', icon: ICONS.calendar, path: '/panel/planning', roles: ['hotel_admin', 'receptionist'],
  },
  {
    label: 'Reservas', icon: ICONS.ticket, roles: ['hotel_admin', 'receptionist'],
    children: [
