...
const messages = {
  es: {
    ...
    'search.adultsHint': '13 años o más',
    'search.children': 'Niños',
    'search.childrenHint': '0 a 12 años',
    'search.rooms': 'Habitaciones',
    'search.roomsHint': 'Unidades a reservar',
    ...
    'rooms.emptyHint': 'Probá con otras fechas o menos huéspedes.',
    ...
    // Régimen — PLACEHOLDER (el backend todavía no modela pensiones, ver RoomsStep.vue).
    'rooms.board.label': 'Régimen',
    'rooms.board.roomOnly': 'Sólo alojamiento',
    'rooms.board.breakfast': 'Desayuno',
    'rooms.board.halfBoard': 'Media pensión',
    'rooms.board.fullBoard': 'Pensión completa',
    'rooms.board.unavailable': 'Este hotel no vende este régimen por ahora',
    ...
    'guest.notes': 'Notas (opcional)',
    'guest.notesPlaceholder': 'Pedidos especiales, hora de llegada…',
  ...
  en: {
    ...
    'search.adultsHint': '13 years or older',
    'search.children': 'Children',
    'search.childrenHint': '0 to 12 years',
    'search.rooms': 'Rooms',
    'search.roomsHint': 'Units to book',
    ...
    'rooms.emptyHint': 'Try different dates or fewer guests.',
    ...
    'rooms.board.breakfast': 'Breakfast',
    'rooms.board.halfBoard': 'Half board',
    'rooms.board.fullBoard': 'Full board',
    'rooms.board.unavailable': 'This hotel does not sell this board plan yet',
    ...
    'guest.email': 'Email *',
    'guest.phone': 'Phone *',
    'guest.notes': 'Notes (optional)',
    'guest.notesPlaceholder': 'Special requests, arrival time…',
  ...
  pt: {
    ...
    'search.adults': 'Adultos',
    'search.adultsHint': '13 anos ou mais',
    'search.children': 'Crianças',
    'search.childrenHint': '0 a 12 anos',
    ...
    'rooms.emptyHint': 'Tente outras datas ou menos hóspedes.',
    ...
    'rooms.board.breakfast': 'Café da manhã',
    'rooms.board.halfBoard': 'Meia pensão',
    'rooms.board.fullBoard': 'Pensão completa',
    'rooms.board.unavailable': 'Este hotel ainda não vende este regime',
    ...
    'guest.notes': 'Notas (opcional)',
    'guest.notesPlaceholder': 'Pedidos especiais, horário de chegada…',
