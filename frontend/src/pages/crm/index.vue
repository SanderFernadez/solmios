  ...
  <div>
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        <div v-if="showCouponForm" class="fixed inset-0 z-50 flex items-center justify-center p-4" @click.self="showCouponForm = false">
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        <div v-if="showSegmentForm" class="fixed inset-0 z-50 flex items-center justify-center p-4" @click.self="showSegmentForm = false">
          <div class="absolute inset-0 bg-navy/40 backdrop-blur-sm"></div>
          <div class="modal-panel relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden">
            <div class="shrink-0 p-5 border-b border-border flex items-center justify-between">
