  ...
  <div>
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        <div v-if="connectDialog" class="fixed inset-0 z-50 flex items-center justify-center p-4" @click.self="cancelConnect">
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        <div v-if="configDialog" class="fixed inset-0 z-50 flex items-center justify-center p-4" @click.self="closeConfig">
          <div class="absolute inset-0 bg-navy/40 backdrop-blur-sm"></div>
